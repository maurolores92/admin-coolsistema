...
function SearchIcon({color='#45b174', width = 20, height=20, style=null}: {color?: string, width?: number, height?:number, style?: any}) {
  return (
    <SvgIcon viewBox="0 0 361.28 360.68" width={width} height={height} style={style}>
      <path fill={color} d="M161.75,0c7.39,1.17,14.9,1.84,22.15,3.59c45.1,10.88,78.93,36.72,99.01,78.59
